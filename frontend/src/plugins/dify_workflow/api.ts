...
export const difyWorkflowApi = {
  ...
  inputSchema(
    ...
    return authFetch<WorkflowInputSchemaResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/input-schema${query ? `?${query}` : ""}`,
    );
  },
  ...
  ioContract(
    ...
    return authFetch<WorkflowIoContractResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/io-contract${query ? `?${query}` : ""}`,
    );
  },
  ...
  importDify(input: {
    ...
    return authFetch<WorkflowImportResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/import/dify`,
      {
        method: "POST",
  ...
  publish(
    ...
    return authFetch<WorkflowLifecycleResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/publish`,
      {
        method: "POST",
  ...
  unpublish(workflowId: string): Promise<WorkflowLifecycleResponse> {
    return authFetch<WorkflowLifecycleResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/unpublish`,
      {
        method: "POST",
      },
    );
  ...
  validate(
    ...
    return authFetch<WorkflowValidationResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/validate`,
      {
        method: "POST",
        body: JSON.stringify({ version_id: versionId ?? null }),
      },
  ...
  run(
    ...
    return authFetch<WorkflowRunResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/run`,
      {
        method: "POST",
  ...
  runs(workflowId: string, skip = 0, limit = 20): Promise<WorkflowRunListResponse> {
    ...
    return authFetch<WorkflowRunListResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs?${params}`,
    );
  },
  ...
  pendingApprovals(skip = 0, limit = 20): Promise<WorkflowPendingApprovalListResponse> {
    ...
    return authFetch<WorkflowPendingApprovalListResponse>(
      `${API_BASE}/api/plugins/dify-workflow/approvals/pending?${params}`,
    );
  },
  ...
  runEvents(
    ...
    return authFetch<WorkflowRunEventsResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs/${runId}/events`,
    );
  },

  runEventsStreamUrl(workflowId: string, runId: string): string {
    return `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs/${runId}/events/stream`;
  },
  ...
  cancelRun(workflowId: string, runId: string): Promise<WorkflowRunResponse> {
    return authFetch<WorkflowRunResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs/${runId}/cancel`,
      {
        method: "POST",
      },
    );
  ...
  resumeRun(
    ...
    return authFetch<WorkflowRunResponse>(
      `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs/${runId}/resume`,
      {
        method: "POST",
        body: JSON.stringify({
  ...
  nodeTypes(): Promise<WorkflowNodeTypesResponse> {
    return authFetch<WorkflowNodeTypesResponse>(
      `${API_BASE}/api/plugins/dify-workflow/node-types`,
    );
  },
  ...
  credentials(skip = 0, limit = 50): Promise<WorkflowCredentialListResponse> {
    ...
    return authFetch<WorkflowCredentialListResponse>(
      `${API_BASE}/api/plugins/dify-workflow/credentials?${params}`,
    );
  },
  ...
  upsertCredential(input: {
    ...
    return authFetch<WorkflowCredentialResponse>(
      `${API_BASE}/api/plugins/dify-workflow/credentials`,
      {
        method: "PUT",
        body: JSON.stringify({
          ref: input.ref,
  ...
  deleteCredential(credentialId: string): Promise<{ deleted: boolean; credential_id: string }> {
    return authFetch<{ deleted: boolean; credential_id: string }>(
      `${API_BASE}/api/plugins/dify-workflow/credentials/${credentialId}`,
      { method: "DELETE" },
    );
  },
};
...
async function streamWorkflowRunEvents(
  ...
  const response = await fetch(
    `${API_BASE}/api/plugins/dify-workflow/workflows/${workflowId}/runs/${runId}/events/stream?${params}`,
