...
class DifyWorkflowStorage:
    ...
    def definitions(self) -> "AsyncIOMotorCollection[Any]":
        if self._definitions is None:
            ...
            self._definitions = client[settings.MONGODB_DB]["dify_workflow_definitions"]
    ...
    def versions(self) -> "AsyncIOMotorCollection[Any]":
        if self._versions is None:
            ...
            client = get_mongo_client()
            self._versions = client[settings.MONGODB_DB]["dify_workflow_versions"]
    ...
    def runs(self) -> "AsyncIOMotorCollection[Any]":
        if self._runs is None:
            ...
            client = get_mongo_client()
            self._runs = client[settings.MONGODB_DB]["dify_workflow_runs"]
        return self._runs
    ...
    def events(self) -> "AsyncIOMotorCollection[Any]":
        if self._events is None:
            ...
            client = get_mongo_client()
            self._events = client[settings.MONGODB_DB]["dify_workflow_run_events"]
        return self._events
    ...
    def credentials(self) -> "AsyncIOMotorCollection[Any]":
        if self._credentials is None:
            ...
            client = get_mongo_client()
            self._credentials = client[settings.MONGODB_DB]["dify_workflow_credentials"]
