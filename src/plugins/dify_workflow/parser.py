...
from src.plugins.dify_workflow.compatibility import COMPATIBILITY_MATRIX
from src.plugins.dify_workflow.models import WORKFLOW_MODEL_FORMAT
...
class DifyWorkflowParseResult:
    internal_model: dict[str, Any]
    report: dict[str, Any]


def parse_dify_workflow(source_payload: dict[str, Any], *, name: str) -> DifyWorkflowParseResult:
    ...
    return DifyWorkflowParseResult(internal_model=internal_model, report=report)
