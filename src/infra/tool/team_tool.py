...
async def create_agent_team(
    ...
    members: Annotated[
        ...
        "sandbox_enabled (optional boolean; true only when this member should run in "
        "the sandbox runtime, default false), "
    ...
    try:
        team_members = [
            TeamMemberCreate(
                ...
                sandbox_enabled=bool(item.get("sandbox_enabled", False)),
