...
def test_minimal_executor_resolves_dify_sys_query_from_query_alias() -> None:
    model = {
        "graph": {
            "nodes": [
                {"id": "start", "type": "start", "supported": True, "data": {}},
...
@pytest.mark.asyncio
async def test_minimal_executor_async_resolves_dify_sys_query_from_message_alias() -> None:
    model = {
        "graph": {
            "nodes": [
                {"id": "start", "type": "start", "supported": True, "data": {}},
...
def test_minimal_executor_variable_assign_accepts_dify_assignment_lists() -> None:
    model = {
        "graph": {
            "nodes": [
                {"id": "start", "type": "start", "supported": True, "data": {}},
...
def test_minimal_executor_document_extractor_unwraps_dify_file_payloads() -> None:
    model = {
        "graph": {
            "nodes": [
                {"id": "start", "type": "start", "supported": True, "data": {}},
...
@pytest.mark.asyncio
async def test_minimal_executor_tool_call_accepts_dify_parameter_descriptors() -> None:
    calls = []
...
@pytest.mark.asyncio
async def test_minimal_executor_llm_accepts_dify_prompt_template_messages() -> None:
    requests = []
...
@pytest.mark.asyncio
async def test_minimal_executor_llm_accepts_dify_generation_parameters() -> None:
    requests = []
...
@pytest.mark.asyncio
async def test_minimal_executor_http_request_accepts_dify_descriptor_fields() -> None:
    requests = []
